...
# Related question: looking at a subtree of a graph,
# can we determine where or not it could be generated by a dfs?
# What properties of dfs are essential for topo sort and strong components?
