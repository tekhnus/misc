...
LOCAL char *prog_append_backquoted_statement(prog_slice *sl,prog **begin,datum *stmt,prog *(*module_source)(char *module));
...
LOCAL char *prog_init_routine(prog_slice *sl,prog *s,datum *stmt,prog *(*module_source)(char *));
...
char *prog_init_submodule(prog *s,datum *source,prog *(*module_source)(char *));
LOCAL char *prog_append_statement(prog_slice *sl,prog **begin,datum *stmt,prog *(*module_source)(char *));
