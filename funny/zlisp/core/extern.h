...
LOCAL char *prog_append_apply(vec *sl,datum *s_expr,datum *compdata,datum *future_compdata,extension *ext);
...
LOCAL char *prog_append_expression(vec *sl,datum *stmt,datum *compdata,datum *future_compdata,extension *ext);
void prog_append_yield(vec *sl,datum type,size_t count,size_t recieve_count,datum meta,datum *compdata);
LOCAL char *prog_append_consume_expression(vec *sl,datum *source,int *i,datum *compdata,datum *future_compdata,extension *ext);
LOCAL char *prog_append_expressions_impl(vec *sl,datum *source,datum *compdata,datum *future_compdata,extension *ext);
