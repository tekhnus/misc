...
.fntest.arity = 3
defn .backquote {exp}
{if (/std/not- (/std/eq- (/std/type- exp) :list)) {return {list {'quote exp}}} {if (/std/not- exp) {return {list {'list {list {}}}}} {if (/std/eq- (/std/length- exp) 2) {if (/std/eq- (/std/list-at- exp 0) 'tilde) {return (/std/list-at- exp 1)} {return {list {'call {list {'/std/cons (../.backquote (/std/head- exp)) (../.backquote (/std/tail- exp))}}}}}} {return {list {'call {list {'/std/cons (../.backquote (/std/head- exp)) (../.backquote (/std/tail- exp))}}}}}}}}
