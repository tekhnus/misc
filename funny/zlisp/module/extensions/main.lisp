...
{return (list 'brackets 'defn name '() (list 'brackets 'defn 'original-func args body (list '() '= (list 'original-func '(at mut) '(at pre) '(at 0) '(at up2))) 'return :shouldnt-go-here) (list '() '= (list name '(at mut) '(at 0))))}
