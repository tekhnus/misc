...
malloc :=
(/prelude/c-function libc "malloc" {list
  {{list
    {'sizet}}
   'pointer}})

fopen :=
(/prelude/c-function libc "fopen" {list
  {{list
    {'string
     'string}}
   'pointer}})
...
fread :=
(/prelude/c-function libc "fread" {list
  {{list
    {'pointer
     'sizet
     'sizet
...
feof :=
(/prelude/c-function libc "feof" {list
  {{list
    {'pointer}}
   'int}})

fprintf :=
(/prelude/c-function libc "fprintf" {list
  {{list
    {'pointer
     'string}}
   'sizet}})
...
printfptr :=
(/prelude/c-function libc "printf" {list
  {{list
    {'string
     'pointer}}
   'sizet}})
