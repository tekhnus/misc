...
LOCAL char *prog_build_dep(vec *sl,size_t *p,datum *dep_and_sym,fdatum(*module_bytecode)(char *,datum *,extension_fn *),datum *settings,datum *compdata,extension_fn *ext);
LOCAL void prog_put_deps(vec *sl,size_t *p,datum *deps,datum *compdata);
LOCAL char *prog_build_deps(vec *sl,size_t *p,datum *deps,fdatum(*module_bytecode)(char *,datum *,extension_fn *),datum *settings,datum *compdata,extension_fn *ext);
