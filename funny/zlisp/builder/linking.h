...
#define LOCAL static
LOCAL void prog_build_dep(vec *sl,datum *dep_and_sym,datum(*module_bytecode)(char *,datum *,extension *,context *ctxt),datum *settings,datum *compdata,extension *ext,context *ctxt);
LOCAL void get_varname(char *res,datum *dep_and_sym);
LOCAL void prog_build_deps(vec *sl,datum *deps,datum(*module_bytecode)(char *,datum *,extension *,context *ctxt),datum *settings,datum *compdata,extension *ext,context *ctxt);
