...
LOCAL char *prog_append_backquoted_statement(prog_slice *sl,prog **begin,datum *stmt,fdatum(*module_source)(prog_slice *sl,prog *p,char *));
LOCAL void prog_append_return(prog_slice *sl,prog **begin,bool hat);
LOCAL void prog_append_import(prog_slice *sl,prog **begin);
LOCAL char *prog_append_require(prog_slice *sl,prog **begin,char *pkg,fdatum(*module_source)(prog_slice *sl,prog *p,char *));
LOCAL void prog_append_set_closures(prog_slice *sl,prog **begin,prog *p,datum *var,bool hat);
LOCAL char *prog_init_routine(prog_slice *sl,prog *s,datum *stmt,fdatum(*module_source)(prog_slice *sl,prog *p,char *));
...
LOCAL char *prog_append_statement(prog_slice *sl,prog **begin,datum *stmt,fdatum(*module_source)(prog_slice *sl,prog *p,char *));
